...
export default function EditProfilePage() {
    ...
    return (
        <div className="container mx-auto px-4 py-4 space-y-6">
                ...
                <div>
                    <Link href="/profile/developer" className="hover:cursor-pointer">
                        <button
                ...
                <div className="glass-card p-8 border bg-white/5 backdrop-blur-sm rounded-xl mb-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                        {skills.map((skill) => (
                            <span key={skill}
                                  className="px-4 py-2 rounded-lg bg-white/10 text-white/90 border border-white/20 font-medium flex items-center gap-2">
                                    {skill}
                    ...
                    <div className="flex gap-2">
                        ...
                        <button onClick={addSkill}
                                className="bg-blue-600 hover:bg-blue-700 text-white px-3 rounded-md shadow-md">
                            <Plus className="h-4 w-4"/>
                        </button>
                    </div>
                </div>

                <div className="glass-card p-8 rounded-xl border border-white/10 mb-6 bg-white/5 backdrop-blur-sm">
                    ...
                    <div className="space-y-6">
                            ...
                            <div key={index} className="p-4 rounded-lg bg-white/5 border border-white/10">
                                <div className="flex w-full justify-end my-2 ">
                                    <button onClick={() => setExperience(experience.filter((_, i) => i !== index))}
                                            className="flex items-center px-2 py-2 text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-md cursor-pointer"
                                    >
                        ...
                        <button
                            ...
                            className="flex items-center justify-center cursor-pointer w-full bg-blue-600 hover:bg-blue-700 text-white rounded-md py-2"
                        >
                ...
                <div className="flex gap-4 bg-white/5 backdrop-blur-sm">
