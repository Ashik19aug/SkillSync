                ...
                <div className="glass-card rounded-xl p-6">
                    <div className="flex items-center justify-between">
                        <div className="space-y-1 mb-6">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-2xl font-bold text-foreground">Create Developer Account</h2>
                            </div>
                            <p className="text-sm text-muted-foreground">Join our platform to discover exciting
                                opportunities</p>
                        </div>
                        <div>
                            <Link
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col gap-4 mt-6">
                            <button
                                type="submit"
                                className="w-full bg-accent hover:bg-accent/90 text-accent-foreground py-2 rounded-md shadow-md"
                                disabled={isLoading}
                            >
